...
> ```Bash
> bash build_search_space.sh --name antonym --prompt_path <path/to/prompt/file> --model gpt-4
> ```
...
>```Bash
>bash build_search_space.sh --name synonym --prompt_path <path/to/prompt/file> --model gpt-4
>```
